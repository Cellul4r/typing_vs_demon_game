...
public class SoundManager {
    ...
    public SoundManager(){
        ...
        sound[2] = new Sound("/resource/sound_res/enemy_dead.wav", -20.0f);
        ...
        sound[6] = new Sound("/resource/sound_res/player_lose_sound.wav", 0.0f);
        sound[7] = new Sound("/resource/sound_res/healing_sound.wav", 0.0f);
        sound[8] = new Sound("/resource/sound_res/freeze_sound.wav", 0.0f);
        sound[9] = new Sound("/resource/sound_res/bomb_sound.wav", 0.0f);
    }
